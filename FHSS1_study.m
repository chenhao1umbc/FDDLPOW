...
figure; plot(rt(ii, :),'x'); grid on;grid minor
end
...
figure; imagesc(Z2+ Z6); title 'trained BT+Zigbee';colorbar
...
figure; imagesc(Z6); title 'zigbee'; colorbar
...
figure; imagesc(W'*Z6); title 'zigbee'; colorbar
...
figure; imagesc(W'*(Z2 + Z6)); title 'bt + zigbee'; colorbar
close all
