function [opts]=loadoptions_grid(whichtable, K,lambda1,mu,Q,nu,beta, SNR)
...
if whichtable == 2
opts.Dictnm =['FDDLPO',opts.dataset,'_k',num2str(opts.K),'_lmbd',num2str(opts.lambda1)...
    ,'_mu',num2str(opts.mu),'_nu',num2str(opts.nu), '_Q',num2str(opts.Q),'.mat' ];
end

if whichtable == 3
opts.Dictnm =['FDDLPOW',opts.dataset,'_k',num2str(opts.K),'_lmbd',num2str(opts.lambda1),...
