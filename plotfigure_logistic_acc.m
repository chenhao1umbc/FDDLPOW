...
legend('FDDLO and log. regr. using mixture labels',...
    'FDDLOW and log. regr. using mixture labels',...
    'FDDLO and log. regr. without mixture labels',...
    'FDDLOW and log. regr. without mixture labels',...
    'FDDLOW and ZF without mixture labels',...
    'alg. 3 and ZF without mixture labels','Location', 'southwest');
