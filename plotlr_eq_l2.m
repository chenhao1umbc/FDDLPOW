...
legend('DDL and log. regr. using mixture labels',...
    'DDLW and log. regr. using mixture labels',...
    'DDL and log. regr. without mixture labels',...
    'DDLW and log. regr. without mixture labels',...
    'DDL and ZF without mixture labels',...
    'DDLW and ZF without mixture labels','Location', 'southwest');
