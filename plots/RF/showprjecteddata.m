...
>>>>>>> 08ff3a0449afe53e0af4a7d7a9b2855ed5c36fcc:plots/RF/showprjecteddata.m
...
if isfield(Dict_mix, 'V')
    OmegaWZDeltaV = norm(WtZM1' - Delta*V, 'fro')^2; % overall whitening term
%     OmegaWZDeltaV = 0;
%     for ii = 1:C    
