...
save(['test_L=',num2str(mixture_n),'_ker_last5.mat'],'r_svm', 'r_svm_weak');
...
legend('all', 'weak')
title(['L=', num2str(mixture_n), 'alg123 + ker'])
savefig(['L=', num2str(mixture_n), 'alg123 + ker.fig'])
%%
mixture_n = 3; 
...
ylabel('accuracy')
legend('all', 'weak')
title(['L=', num2str(mixture_n), 'ksvd + ker'])
savefig(['L=', num2str(mixture_n), 'ksvd + ker.fig'])
...
ylabel('accuracy')
legend('all', 'weak')
title(['L=', num2str(mixture_n), 'lrsdl + ker'])
savefig(['L=', num2str(mixture_n), 'lrsdl + ker.fig'])
