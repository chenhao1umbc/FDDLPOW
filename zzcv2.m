...
% end   
% end
% save('0.015_test_L=3.mat','r_zf', 'r_zf_weak', 'r_mf', 'r_mf_weak', 'r_nn','r_nn_weak','r_lr','r_lr_weak');
% 
% 
% %% 2 weak
% mixture_n = 3; 
...
%     if pctrl.db == 0   pctrl.equal = 1;  pctrl.if2weak = 0; else    pctrl.equal = 0; end
%     Database = load_data_new(mixture_n, SNR_INF, pctrl, 1000);   
% for f = 1000:1004
% for alg = 1:3
% 
...
% end   
% end
% save('0.015_2w_test_L=3.mat','r_zf', 'r_zf_weak', 'r_mf', 'r_mf_weak', 'r_nn','r_nn_weak','r_lr','r_lr_weak');
